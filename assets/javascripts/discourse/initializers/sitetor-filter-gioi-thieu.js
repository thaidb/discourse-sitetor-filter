...
import GioiThieuListingModal from "discourse/plugins/discourse-sitetor-filter/discourse/components/modal/gioi-thieu-listing";
...
export default {
  name: "sitetor-filter-gioi-thieu",
  ...
  initialize(container) {
    ...
    const demandIds = (siteSettings.sitetor_filter_demand_categories || "")
      .split("|")
      .map((s) => parseInt(s, 10))
      .filter(Boolean);
    ...
    withPluginApi((api) => {
      api.registerTopicFooterButton({
        ...
        priority: 240,
        translatedLabel() {
          return i18n("sitetor_filter.gioi_thieu");
        },
        translatedTitle() {
          return i18n("sitetor_filter.gioi_thieu");
        },
